...
abstract class Sortable_Objects_Base
{
    ...
    {
        $properties = Guctility_Belt::infer_object_properties($object_type);
        ...
        $apex_objects = Guctility_Belt::sort_objects_array($apex_objects, $apex_order, $object_id);
        $hierarchy_objects = Guctility_Belt::sort_objects_array($hierarchy_objects, $hierarchy_order, $object_id);

        // $apex_objects = Guctility_Belt::sort_objects_by_meta($apex_objects, $object_type, $orderby_apex);
        // $hierarchy_objects = Guctility_Belt::sort_objects_by_meta($hierarchy_objects, $object_type, $orderby_hierarchy);
